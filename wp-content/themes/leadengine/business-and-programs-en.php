				...
				<?php while ($business_query->have_posts()) : $business_query->the_post(); ?>
					...
					<div class="custom-business row">
						...
						<div class="business_details col-lg-12">
							<div class="col-lg-4">
								Year: <?= substr($business_years, 0, -2); ?>
							</div>
							<div class="col-lg-4">
								Settlement Amount: <?= number_format($business_amount); ?>
							</div>
							<div class="col-lg-4">
							...
							<?php while( have_rows('list') ): the_row(); ?>
								...
								<div class="business_categories col-lg-12">
									...
									<div class="cat_desc col-lg-3">
										<strong>Category's Total Number Of People: 10,000</strong>
									</div>
										...
										<?php if( $programs ): ?>
											<?php foreach( $programs as $single_program ): ?>
												...
												<div class="program_title">
													<?php echo $single_program->post_title; ?>	
												</div>
												<div class="program_meta row">
													...
													<div class="col-lg-4 program-amount">
														Settlement Amount:  <?= number_format($program_amount); ?>
													</div>
